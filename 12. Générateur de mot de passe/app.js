...
rangeLabel.textContent = `Taille de votre mot de pass: ${range.value}`
...
range.addEventListener("input", selectRange)

function selectRange(e){
  passwordLength = e.target.value;
  rangeLabel.textContent = `Taille de votre mot de pass: ${passwordLength}`
}
